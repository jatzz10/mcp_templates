#!/usr/bin/env python3
"""
Gemini LLM Wrapper for FileSystem MCP Server

A wrapper class that provides a consistent interface for using Google's Gemini LLM
with the filesystem MCP server. This wrapper mimics the NailLLMLangchain interface
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_prompt = "List the files in the current directory"
