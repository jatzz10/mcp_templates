#!/usr/bin/env python3
"""
Gemini LLM Wrapper for REST API MCP Server

A wrapper class that provides a consistent interface for using Google's Gemini LLM
with the REST API MCP server. This wrapper mimics the NailLLMLangchain interface
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_prompt = "Get the first 10 users from the API"
